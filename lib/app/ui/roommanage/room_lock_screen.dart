...
class RoomLockScreen extends StatefulWidget {
  Room room;

  RoomLockScreen({Key? key, required this.room}) : super(key: key);

  @override
  State<RoomLockScreen> createState() => _RoomLockScreenState();
}

class _RoomLockScreenState extends State<RoomLockScreen> {
  int roomnumber1 = 0;
  int roomnumber2 = 0;
  int roomnumber3 = 0;
  int total = 0;
